...
public class MockEndpointConnectionFactory implements EndpointConnectionFactory {
    @Override
    public EndpointConnection createConnection(EndpointContext descriptor) {
        return new MockEndpointConnection(descriptor);
    }

    @Override
    public boolean isSupportedEndpointType(String endpointType) {
        return "mock".equalsIgnoreCase(endpointType);
    }
}
